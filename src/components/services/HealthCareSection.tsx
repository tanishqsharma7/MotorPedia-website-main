  ...
  return (
    <section className="stp-30 sbp-30">
      <div className="container grid grid-cols-12 gap-6 max-xxl:overflow-hidden">
        <div className="col-span-12 lg:col-span-6 xxl:col-span-5">
          <div className=" flex justify-start items-start flex-col">
            ...
            <p className=" text-bodyText pb-10">
              Get all your vehicles certified by professionals and enable
              different warranty options for all your vehicles sold
            </p>
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-start-7 flex flex-col gap-6 xl:gap-10 justify-start items-start lg:pt-36">
