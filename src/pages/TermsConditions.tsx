      ...
      <section className="container pt-10 flex flex-col gap-2">
        <div className=" flex justify-start items-start flex-col">
          <p className=" text-bodyText">
            ...
            Use for access or usage of the Platform.
          </p>
        </div>

        <div className="">
          <p className=" text-bodyText">
            THESE TERMS OF USE ARE SUBJECT TO REVISION BY US AT ANY TIME PLEASE
            READ THESE TERMS AND CONDITIONS OF USE CAREFULLY BEFORE USING OR
            REGISTERING, BROWSING OR ACCESSING OR OTHERWISE USING THE PLATFORM.
            THE REVISED TERMS OF USE SHALL BE MADE AVAILABLE ON THE PLATFORM.
            YOU ARE REQUESTED TO VIEW THE MOST CURRENT TERMS OF USE. IT SHALL BE
            YOUR RESPONSIBILITY TO CHECK THESE TERMS OF USE PERIODICALLY FOR
            CHANGES. WE MAY REQUIRE YOU TO PROVIDE YOUR DIRECT OR INDIRECT
            CONSENT TO ANY UPDATE IN A SPECIFIED MANNER BEFORE FURTHER USE OF
            THE PLATFORM. IF NO SUCH SEPARATE CONSENT IS SOUGHT YOUR CONTINUED
            USE OF THE PLATFORM SHALL SIGNIFY YOUR ACCEPTANCE OF THE TERMS OF
            USE AND YOUR AGREEMENT TO BE LEGALLY BOUND BY THE SAME.
          </p>
          <p className=" text-bodyText pt-6">
            REFERENCE TO MOTOR VEHICLES SHALL MEAN THE REFERENCE TO PRE-OWNED
            CARS ONLY UNLESS THE PLATFORM OFFERS SERVICES EXTENDED TO OTHER
            FORMS OF AUTOMOBILES IN WHICH CASE THE TERM AUTOMOBILES SHALL
            INCLUDE SUCH OTHER FORMS.
          </p>
        </div>

        <div className="">
          <h3 className="heading-2 py-6">Eligibility to Use : </h3>
          <li>
            Use of the Platform is not available to minors under the age of
            ...
            contract and are not a person barred from receiving the Services
          ...
          <li>
            You shall not have more than one active Account (defined hereunder)
            on the Platform. Additionally, You are prohibited from selling,
            trading, or otherwise transferring Your Account to another person.
          </li>
        </div>
        ...
        <div className="">
          ...
          <li>
            ...
            complete and inform Us immediately of any changes to the information
            that you provided when registering. You can access and update much
            of the information you provided Us with in the Your Account area of
          ...
          <li>
            You may be required to provide certain personal information and We
        ...
        <div className="">
          ...
          <li>
            You agree to use the Platform Services, Platform and the materials
            provided therein only: (a) for purposes that are permitted by the
            Terms of Use; and (b) in accordance with any applicable law,
          ...
          <li>
            ...
            Platform or Content (as defined below), or in any way reproduce or
          ...
          <li>
            ...
            <li>
              Publish, post, upload, distribute or disseminate any information
              that is harmful, harassing, blasphemous, defamatory, obscene,
              pornographic,paedophilic, libellous, hateful, or racially,
              ethnically objectionable, disparaging, inappropriate, profane,
              infringing or otherwise unlawful in any manner whatever; or that
            ...
            <li>
              ...
              applicable intellectual property laws unless you own or control
            ...
            <li>
              ...
              operation of the platform or another's computer;
            </li>
            <li>
              Engage in any activity that interferes with or disrupts access to
              the platform or the platform services (or the servers and networks
            ...
            <li>
              ...
              trace any information on any other user, registered trading
              partner, other customer, of or visitor to, the platform, to its
              source, or exploit the platform or platform services or
              information made available or offered by or through the platform,
              in any way whether or not the purpose is to reveal any
            ...
            <li>
              Collect or store data about others customers/users in connection
            ...
            <li>
              ...
              applicable for or to any particular platform service;
            </li>
          </li>
          <li>
        ...
        <div className="">
          ...
          <li>
            ...
            <li>
              ...
              informational, and internal purposes, in accordance with the terms
              of use;
            </li>
            <li>
              You may not modify or alter the materials available on the
              platform;
            </li>
            <li>
              You may not distribute or sell, rent, lease, license or otherwise
              make the materials on the platform available to others; and
            </li>
            <li>
              You may not remove any text, copyright or other proprietary
              notices contained in automobile service related catalogues or any
              other materials available on the platform.
            </li>
          </li>
          <li>
            The rights granted to you in the materials as specified above are
            not applicable to the design, layout or look and feel of the
            platform. Such elements of the platform are protected by
            intellectual property rights and may not be copied or imitated in
            whole or in part.
          </li>
          <li>
        ...
        <div className="">
          <h3 className="heading-3 py-6">Usage Conduct : </h3>
          <li>
            ...
            access, use and transact on the Platform.
          </li>
        </div>

        <div className="">
          <h3 className="heading-3 py-6">Intellectual Property Rights : </h3>
          <li>
            Subject to section 7 below, the platform and the processes, and
        ...
        <div className="">
          ...
          <ul>
            <li>
              ...
              THE PLATFORM OR PLATFORM SERVICES WILL BE EFFECTIVE, ACCURATE OR
              RELIABLE; (III) THE QUALITY OF THE PLATFORM OR PLATFORM SERVICES
            ...
            <li>
              ...
              OUR CONTROL. THE TRADING PARTNER UNDERSTANDS AND AGREES THAT ANY
              MATERIAL OR DATA DOWNLOADED OR OTHERWISE OBTAINED THROUGH THE
              PLATFORM IS DONE ENTIRELY AT BUYER’S OWN DISCRETION AND RISK, AND
        ...
        <div className="">
          ...
          <li>
            ...
            thereon) asserted against or incurred by the Indemnitees that arise
            ...
            these Terms of Use. Further, You agree to hold the Indemnitees
            harmless against any claims made by any third party due to, or
            arising out of, or in connection with, Your use of the Platform or
            Platform Services, Your violation of the Terms of Use, or Your
        ...
        <div className="">
          <h3 className="heading-3 py-6">Termination : </h3>
          <ul>
            <li>
            ...
            <li>
              ...
              <ul>
                <li>
                  {" "}
                  1. You breach any of the provisions of the Terms of Use, the
                  Privacy Policy or any other terms, conditions, or policies
                  that may be applicable to You from time to time (or have acted
                  in a manner that clearly shows that You do not intend to, or
            ...
            <li>
              ...
              Platform Services; (ii) deletion of Your records and Account
              information, including Your personal information, log-in ID and
              password, and all related information, files and materials
              associated with or inside Your Account (or any part thereof); and
              (iii) barring of further use of the Platform and Platform
              Services:
              <ul>
                <li>
                  1. The termination of Your Account shall not relieve You of
                  any liability that You may have incurred or may incur in
                  relation to use of Platform Services provided prior to such
                  termination;
                </li>
                <li>
        ...
        <div className="">
          <h3 className="heading-3 py-6">Governing Law : </h3>
          <ul>
            <li>
        ...
        <div className="">
          <h3 className="heading-3 py-6">Rebort Abuse : </h3>
          <li>
        ...
        <div className="">
          ...
          <ul>
            ...
            <li>
              III. Severability: If, for any reason, a court of competent
        ...
        <div className="">
          <h3 className="heading-3 py-6"> Feedback and Information : </h3>
          <ul>
            <li>
